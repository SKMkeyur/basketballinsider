...
class FixtureMatchDataFootballUpcomingScreen extends StatefulWidget {
  late int id;
  FixtureMatchDataFootballUpcomingScreen(this.id);
  @override
  _FixtureMatchDataFootballUpcomingScreenState createState() => _FixtureMatchDataFootballUpcomingScreenState();
}

class _FixtureMatchDataFootballUpcomingScreenState extends State<FixtureMatchDataFootballUpcomingScreen> {
                                          ...
                                          Flexible(
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Flexible(child:
                                                Text(
                                                  oppositeteamByIdFootball1.data!.squad!.data![index].captain.toString()=="0"?
                                                  "":"(c)"
                                                  //oppositeteamByIdFootball1.data!.squad!.data![index].rating.toString()
                                                  ,style: TextStyle(color: Colors.white),))
                                              ],
