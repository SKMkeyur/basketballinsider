...
class GetStarted02 extends StatefulWidget {
  const GetStarted02({Key? key}) : super(key: key);

  @override
  _GetStarted02State createState() => _GetStarted02State();
}

class _GetStarted02State extends State<GetStarted02> {
  @override
            ...
            children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          height: height*0.3,
                          width: width*0.5,
                          child: Image.asset("graphic_res/gs2.png",fit: BoxFit.contain,),
              ...
              Container(
                ...
                child: Container(
                    ...
                    child: Column(
                      children: [
                        const Text("To get started with BetOnline, head to the sportsbook's website and click 'john.'",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 14,
                        ...
                        SizedBox(height: 20,),
                        const Text("Enter your name, birthday, email, phone number, and a password to create a new account",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w400,
                ...
                child: Row(
                  children: [
                    ...
                    height:  height*0.12,
                      child:
                      Padding(
                        padding: const EdgeInsets.fromLTRB(70, 18, 30, 18),
