...
class GetStarted04 extends StatefulWidget {
  const GetStarted04({Key? key}) : super(key: key);

  @override
  _GetStarted04State createState() => _GetStarted04State();
}

class _GetStarted04State extends State<GetStarted04> {
  @override
            ...
            children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          height: height*0.3,
                          width: width*0.5,
                          child: Image.asset("graphic_res/gs4.png",fit: BoxFit.contain,),
              ...
              Container(
                ...
                child: Container(
                    ...
                    child: const Text('Place your First Bet',
              ...
              Container(
                ...
                child: Container(
                    ...
                    child: Column(
                      children: [
                        const Text("Now you're ready to start wagering with BetOnline. Find"
                            "your favorite game and then tap on the Betslip button in the "
                            "app menu. Enter your wager details and then tap 'Review Bet' when "
                            "you're ready. If your bet looks good, click 'Place",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 14,
