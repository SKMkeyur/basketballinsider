...
class FixtureMatchDataCricketLiveScreen extends StatefulWidget {
  //const PreviousMatchDataFootballScreen({Key? key}) : super(key: key);
  late int id;
  FixtureMatchDataCricketLiveScreen(this.id);
  @override
  _FixtureMatchDataCricketLiveScreenState createState() => _FixtureMatchDataCricketLiveScreenState();
}

class _FixtureMatchDataCricketLiveScreenState extends State<FixtureMatchDataCricketLiveScreen> {
