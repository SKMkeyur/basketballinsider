...
class CrickerMainCanceledScreen extends StatefulWidget {
  ...
  @override
  _CrickerMainCanceledScreenState createState() => _CrickerMainCanceledScreenState();
}
...
class _CrickerMainCanceledScreenState extends State<CrickerMainCanceledScreen> {
          ...
          child: TabBarView(
            children: [
             ...
             isLoading1==false && isLoading0==false?
                 ...
                 Container(
                   child: Center(child: Text("Match Canceled",style: TextStyle(color: Colors.white),)),
                 )
              ,
              isLoading0==false?
              CustomScrollView(
                ...
                slivers: [
                  ...
                  :Center(child: Center(child: Text("Match Canceled",style: TextStyle(color: Colors.white),)),)
              ,
              isLoading1==false && isLoading0==false?
              Container(
