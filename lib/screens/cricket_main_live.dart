...
class CrickerMainLiveScreen extends StatefulWidget {
  ...
  @override
  _CrickerMainLiveScreenState createState() => _CrickerMainLiveScreenState();
}
...
class _CrickerMainLiveScreenState extends State<CrickerMainLiveScreen> {
 ...
 // late List<Squad> squad1 = [];
  ...
  bool firstinning = false;
  bool secondinning= false;
    ...
    FixtureByIdCricketService.getUsers(widget.id).then((sites){
      ...
      if(sites!=null) {
        setState(() {
          ...
          int i1 = cricket.data!.scoreboards!.indexWhere((element) => element.scoreboard=="S1");
          int i2 = cricket.data!.scoreboards!.indexWhere((element) => element.scoreboard=="S2");
          print('========');
          print(i1);
          print('========');
          print(i2);
  ...
  void initState() {
    ...
    timer = Timer.periodic(Duration(seconds: 5), (Timer t) => getScoreCard());

    timer1 = Timer.periodic(Duration(seconds: 5), (Timer t) =>  getScore());
          ...
          child: TabBarView(
            children: [
             ...
             isLoading1==false && isLoading0==false?
                                 ...
                                 children: [
                                   Container(
                                     ...
                                     child: InkWell(
                                       ...
                                       child: Text(""
                                         // (cricket.data!.batting!.indexWhere((element) => element.active.toString()=="true").toString())
                                      //   cricket.data!.batting![cricket.data!.batting!.indexWhere((element) => element.active.toString()=="true")].toString()
                                         // cricket.data!.batting![index].playerId.toString()
                                        // squad.elementAt(squad.lastIndexWhere((element) => element.id==cricket.data!.batting![cricket.data!.batting!.indexWhere((element) => element.active=="True")].playerId)).name
                                         ,style: TextStyle(color: Colors.white),
                                       ),
                                     ),
                                   ),
                                   Container(
                                     ...
                                     child: Text(
                                       ""
                                    //   cricket.data!.batting![cricket.data!.batting!.indexWhere((element) => element.active=="true")].score.toString()
                                   ...
                                   Container(
                                     ...
                                     child: Text(
                                         ""
                                       //cricket.data!.batting![cricket.data!.batting!.indexWhere((element) => element.active=="true")].ball.toString()
                                       ,style: TextStyle(color: Colors.white),
                                     ),
                                   ),
                                   Container(
                                     ...
                                     child: Text(
                                         ""
                                       //cricket.data!.batting![cricket.data!.batting!.indexWhere((element) => element.active=="true")].fourX.toString()
                                       ,style: TextStyle(color: Colors.white),
                                     ),
                                   ),
                                   Container(
                                     ...
                                     child: Text(
                                         ""
                                       //cricket.data!.batting![cricket.data!.batting!.indexWhere((element) => element.active=="true")].sixX.toString()
                                       ,style: TextStyle(color: Colors.white),
                                     ),
                                   ),
                                   Container(
                                     ...
                                     child: Text(
                                    ""
                                       //   cricket.data!.batting![cricket.data!.batting!.indexWhere((element) => element.active=="true")].rate.toString()
                                       ,style: TextStyle(color: Colors.white),
                                     ),
                                   ),
                 ...
                 Container(
                   child: Center(child: Text("Loding...",style: TextStyle(color: Colors.white),)),
                 )
              ,
              isLoading0==false?
              CustomScrollView(
                ...
                slivers: [
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              alignment: Alignment.centerLeft,
                              padding: EdgeInsets.all(20),
                              child: Text(cricket.data!.note.toString(),style: TextStyle(color: Colors.white)),
                            ),
                  ...
                  :Center(child: Center(child: Text("Loading...",style: TextStyle(color: Colors.white),)),)
              ,
              isLoading1==false && isLoading0==false?
              Container(
