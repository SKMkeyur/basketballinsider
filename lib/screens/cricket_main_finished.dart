...
class CrickerMainFinishedScreen extends StatefulWidget {
  ...
  @override
  _CrickerMainFinishedScreenState createState() => _CrickerMainFinishedScreenState();
}
...
class _CrickerMainFinishedScreenState extends State<CrickerMainFinishedScreen> {
    ...
    FixtureByIdCricketService.getUsers(widget.id).then((sites){
      ...
      if(sites!=null) {
        setState(() {
          ...
          isLoading0 = false;
          print(cricket);
          String momid=cricket.data!.manOfMatchId.toString();
          print("momid");
          print(momid);
          GetPlayerInfoByIdCrickerService.getUsers(momid).then((sites) {
            ...
            if(sites!=null){
              ...
              manofmatch=sites.data!.id.toString();
            }
          });
                ...
                slivers: [
                  SliverList(delegate: SliverChildListDelegate(
                    [
                      Container(
                        alignment: Alignment.centerLeft,
                        height: (barheight*9)+(barheight)+
                            (height*0.07*cricket.data!.batting!.length)+
                            (height*0.07*cricket.data!.bowling!.length),
                        width: width,
                        //color: Colors.red,
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: FittedBox(child: Text(
                                  manofmatch==""?
                                      "Man of the Match :    -":
                               "Man of the Match :    " +  manofmatch,style: TextStyle(color: Colors.white))),
                            ),
