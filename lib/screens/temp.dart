...
class _ComparisonScreenState extends State<ComparisonScreen> {
  ...
  final List<MyItems> _items = <MyItems>[
    MyItems(header: "How We Select the Best Betting Apps", body: "Wondering how we choose "
    ...
    MyItems(header: "Licensing & Security", body:
    "One of the first places to start when comparing sports betting apps for real money is to look at where they're licensed."
        ...
        "states"),
    MyItems(header: "How do I claim my sign-up bonus?",body: "We think Bavada is the best betting app in "
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                          alignment: Alignment.center,
                          width: width*0.50,
                          child: Text("Comparison",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color: Colors.black),
                          )
                      ),
                      Container(
                        width: width*0.20,
                            ...
                            Container(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.only(topRight: Radius.circular(0),topLeft:Radius.circular(20),bottomRight: Radius.circular(0),bottomLeft: Radius.circular(20)),
                                ),
                      ...
                      Container(
                          ...
                          ListView.builder(
                              ...
                              itemBuilder: (context,index){
                                ...
                                Comparison comparison = _comparisons[index];
                                int i2=0;
                                for(int i=0;i<_comparisons.length;i++){
                                  if(_sites[index].title.compareTo(_comparisons[i].title)==true){
                                    print(i);
                                    i2=i;
                                  }
                                }
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Image.network(site.bgImage,
                                                      fit: BoxFit.cover,
                                                      height: 60,
                                                      width: width*.45,
                                                  ...
                                                  Container(
                                                      ...
                                                      child: Text(site.title,style: TextStyle(fontSize: 10),)),
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: [
                                                      Container(
                                                      ...
                                                      //  SizedBox(width: 5,),
                                                      Text((site.ratings).toString(), style: TextStyle(fontSize: 16 , color: Colors.grey),),
                                                    ],
                                                  ),
                                                ],
                                              ),
                                          ...
                                          Container(
                                            ...
                                            child:
                                            Text(
                                              _comparisons[_comparisons.indexWhere((element) => element.title==site.title)].bonus,
                                          ...
                                          Container(
                                            ...
                                            child:
                                            Text(
                                              _comparisons[_comparisons.indexWhere((element) => element.title==site.title)].promocode,
                                              textAlign: TextAlign.center,
                                              //   _comparisons[].bonus
